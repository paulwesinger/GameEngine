...
const std::string PATH_HEADLINE     = PATH::ROOT_DIR + "images/darkgray.png";
const std::string PATH_TEXTFIELD    = PATH::ROOT_DIR + "images/Textfeld.png";
const std::string PATH_BOTTOM       = PATH::ROOT_DIR + "images/Bottom.png";
...
void InitGL::InitShaders() {
    ...
    std::string v_source = PATH::ROOT_DIR + "ShaderSources/glasshader.vex";
    vs = shader ->compileVertexShaderFromFile(v_source,filestream);
    //Fragment Shader Color
    v_source = PATH::ROOT_DIR + "ShaderSources/glasshader.frg";
    ...
    v_source = PATH::ROOT_DIR + "ShaderSources/cad2Dshader.vex";
    vs = shader ->compileVertexShaderFromFile(v_source,filestream);
    //Fragment Shader Color
    v_source = PATH::ROOT_DIR + "ShaderSources/cad2Dshader.frg";
    fs = shader ->compileFragmentShaderFromFile(v_source,filestream);
...
// ===============================================================
    ...
    faces.push_back(PATH::ROOT_DIR + "skybox/desert/desert_lf.tga");
    faces.push_back(PATH::ROOT_DIR + "skybox/desert/desert_rt.tga");
    faces.push_back(PATH::ROOT_DIR + "skybox/desert/desert_up.tga");
    faces.push_back(PATH::ROOT_DIR + "skybox/desert/desert_dn.tga");
    faces.push_back(PATH::ROOT_DIR + "skybox/desert/desert_ft.tga");
    faces.push_back(PATH::ROOT_DIR + "skybox/desert/desert_bk.tga");
    skybox -> Load(faces);
    ...
    cubeimages.clear();
    texturesok =  fu.readLine(PATH::ROOT_DIR + "config/cube2textures.cfg",cubeimages);
...
/*
    if (load3DS->Load3DS(PATH::ROOT_DIR + "models/32-sting-sword-lowpoly.3ds"))
